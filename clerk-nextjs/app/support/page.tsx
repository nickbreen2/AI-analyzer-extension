    ...
    >
      <div className="relative flex-1">
        ...
        <main className="flex flex-col items-center justify-center px-6 pt-36 pb-24 text-center">
          ...
          <div className="flex items-center w-full max-w-sm rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 gap-3">
            <span className="flex-1 font-mono text-sm text-gray-900 text-left">{SUPPORT_EMAIL}</span>
